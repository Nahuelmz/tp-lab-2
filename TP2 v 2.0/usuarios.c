...
stCelda * cargarArchiUsuToArreglo(char archiUsu[],stCelda*arregloUsuActivos, int *validos) // Función que carga los usuarios activos del archivo en el arreglo dinámico correspondiente
{
...
stCelda* altaUsuarios(char archiUsu[], stCelda*arregloUsuActivos, int *validos)// Funcion general de alta de usuarios
{
...
void bajaUsuario(char archiUsu[], stCelda*arregloUsuActivos, int validos) //Elimina usuarios pasando asignando valor verdadero al campo "eliminado"
{
    char control='n';
    int idUsu=0;
    int posId=0;
...
int modificarUsuario(char archiUsu[], stCelda*arregloUsuActivos, int validos)//Modificacion de usuario para administrador - NO se muestra el password
{
    int id;
...
int cambiarNombreUsu(char archiUsu[], int id, int pos, stCelda*arregloUsuActivos)
{
    int flag=0;
    stUsuario usuAux;
...
int cambiarPassUsu(char archiUsu[], int id, int pos, stCelda*arregloUsuActivos) /// VER CON NAHUEL
{
    int flag=0;
    stUsuario usuAux;
...
int cambiarAnioUsu(char archiUsu[], int id, int pos, stCelda*arregloUsuActivos)
{
    int flag=0;
    stUsuario usuAux;
...
int cambiarGeneroUsu(char archiUsu[], int id, int pos, stCelda*arregloUsuActivos)
{
    int flag=0;
    stUsuario usuAux;
...
int cambiarPaisUsu(char archiUsu[], int id, int pos, stCelda*arregloUsuActivos)
{
    int flag=0;
    stUsuario usuAux;
...
int cambiarEstadoUsu(char archiUsu[], int id, int pos, stCelda*arregloUsuActivos)
{
    int flag=0;
    stUsuario usuAux;
...
int cambiarPermisosUsu(char archiUsu[], int id, int pos, stCelda*arregloUsuActivos)
{
    int flag=0;
    stUsuario usuAux;
...
///OJO ver momento de implementación
void borrarArregloUsu(stCelda*arregloUsuActivos)  // Borra el arreglo de usuario de listas, invocar después de haber borrado las pelis vistas: nodoListaPelicula* borrarPelisVistas(nodoListaPelicula*lista)
{
