...
stCelda* altaUsuarios(char archiUsu[], stCelda*arregloUsuActivos, int *validos); // Sesión de alta de usuarios: se ingresan los datos al arreglo y se persisten en el archivo
...
int cambiarNombreUsu(char archiUsu[], int id, int pos, stCelda*arregloUsuActivos); // Función invocada por el menu "menumodif" para efectuar el cambio que solicita la misma
int cambiarPassUsu(char archiUsu[], int id, int pos, stCelda*arregloUsuActivos);// Función invocada por el menu "menumodif" para efectuar el cambio que solicita la misma
int cambiarAnioUsu(char archiUsu[], int id, int pos, stCelda*arregloUsuActivos);// Función invocada por el menu "menumodif" para efectuar el cambio que solicita la misma
int cambiarGeneroUsu(char archiUsu[], int id, int pos, stCelda*arregloUsuActivos);// Función invocada por el menu "menumodif" para efectuar el cambio que solicita la misma
int cambiarPaisUsu(char archiUsu[], int id, int pos, stCelda*arregloUsuActivos);// Función invocada por el menu "menumodif" para efectuar el cambio que solicita la misma
int cambiarEstadoUsu(char archiUsu[], int id, int pos, stCelda*arregloUsuActivos);// Función invocada por el menu "menumodif" para efectuar el cambio que solicita la misma
int cambiarPermisosUsu(char archiUsu[], int id, int pos, stCelda*arregloUsuActivos);// Función invocada por el menu "menumodif" para efectuar el cambio que solicita la misma
